...
export function DialogProvider({ children }: DialogProviderProps) {
  const [currentConfig, setCurrentConfig] = useState<DialogConfig | null>(null);
  ...
  return (
    <DialogContext.Provider value={value}>
      {children}
      <Dialog currentDialog={currentConfig} close={close} />
...
function Dialog({ currentDialog, close }: DialogProps) {
  ...
  useKeyboard((key) => {
    if (!currentDialog || !isTopLayer("dialog")) return false;
